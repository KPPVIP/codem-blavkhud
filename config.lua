...
Config.seatbeltkey = "g"   --- set this if RegisterKeymmaping is true
...
Config.Notify1 ={text = "Você colocou o cinto de segurança", type = 'info', time = 5000 }   -- 
Config.Notify2 ={text ="Você tirou o cinto de segurança", type = "info", time = 5000 }  -- 
Config.Notify3 = {text = "Você definiu o limite de velocidade", type ="info" , time  = 5000}  -- 
Config.Notify4 = {text = "Você desabilitou o limite de velociade", type ="info" , time  = 5000}  ---
